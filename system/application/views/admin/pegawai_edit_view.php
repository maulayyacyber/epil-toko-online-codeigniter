	...
	<?=form_open("admin/pegawai/edit_pegawai/".$row->KodePegawai)?>
		...
		<tr><td colspan='3'><div id="header_tabel"> &nbsp == &nbsp DATA DIRI &nbsp == &nbsp </div></td></tr>
			<tr>
				<td>Nama Pegawai</td>
				<td>:</td>
				<td><input class="text-input medium-input2" type="text" size="75px" name="NamaPegawai" value="<?=($row->NamaPegawai)?>"><?php echo form_error('NamaPegawai'); ?></td>
			</tr>
			<tr>
				<td>Jenis Kelamin</td>
				<td>:</td>
			...
			<tr>
				<td>Tempat Lahir</td>
				<td>:</td>
				<td><input class="text-input medium-input2" type="text" size="75px" name="TempatLahir" value="<?=($row->TempatLahir)?>"><?php echo form_error('TempatLahir'); ?></td>
			</tr>
			<tr>
				<td>Tanggal Lahir</td>
				<td>:</td>
			...
			<tr>
				<td>No Telepon</td>
				<td>:</td>
				<td><input class="text-input medium-input2" type="text" size="75px" name="NoTelepon" value="<?=($row->NoTelepon)?>"><?php echo form_error('NoTelepon'); ?></td>
			</tr>
			<tr>
				<td>Email</td>
				<td>:</td>
				<td><input class="text-input medium-input2" type="text" size="75px" name="Email" value="<?=($row->Email)?>"><?php echo form_error('Email'); ?></td>
			</tr>
			<tr>
				<td>Tanggal Masuk</td>
				<td>:</td>
				<td><input  type="text" size="33px" name="TanggalMasuk" class='datepicker text-input medium-input2' value="<?=($row->TanggalMasuk)?>"><?php echo form_error('TanggalMasuk'); ?></td>
			</tr>
			<tr>
